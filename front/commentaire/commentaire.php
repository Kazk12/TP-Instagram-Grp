...
<main>
  ...
  <div class="flex items-start p-1 gap-2">
    <img src="../../GTzblVSWUAAIMp-.jpg" alt="photo de singe" class="w-10 rounded-full">
    <p class="text-white font-sans font-medium text-sm">
  ...
  <div class="flex items-start p-1 gap-2">
    ...
    <p class="text-white font-sans font-medium text-sm">
      ...
      <span class="font-light text-red-400">ah lui il a pas préparer ces 10balle mdrrr</span>
    </p>
  </div>
